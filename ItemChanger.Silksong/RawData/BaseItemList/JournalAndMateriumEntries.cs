...
{
    // TODO: journal entry sprites should be framed icons, as in the inventory menu.

    private static Item CreateJournalEntryItem(string name, string id, LanguageString uiName, LanguageString uiDesc, IValueProvider<Sprite> sprite) => new ItemChangerSavedItem
    {
        Name = name,
