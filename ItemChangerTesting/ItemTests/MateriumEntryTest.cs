...
internal class MateriumEntryTest : Test
{
    public override TestMetadata GetMetadata() => new()
    {
        Folder = TestFolder.ItemTests,
        MenuName = "Materium Entry Items",
        MenuDescription = "Tests various materium entry items",
        Revision = 2026030800,
    };
    ...
    public override void Setup(TestArgs args)
    {
        ...
        Profile.AddPlacement(new CoordinateLocation
        {
            ...
            FlingType = ItemChanger.Enums.FlingType.Everywhere,
            Managed = false,
        }.Wrap().Add(Finder.GetItem(ItemNames.Materium)!));
    }
}
