...
internal class SplitSwiftStepTest : Test
{
    public override TestMetadata GetMetadata() => new()
    {
        Folder = TestFolder.ModuleTests,
        MenuName = "Split Swift Step",
        MenuDescription = "Tests left and right swift step item functionality.",
        Revision = 2026030800
    };
    ...
    public override void Setup(TestArgs args)
    {
        ...
        Profile.AddPlacement(new CoordinateLocation
        {
            ...
            Managed = false,
        }.Wrap().Add(Finder.GetItem(ItemNames.Right_Swift_Step)!));
        Profile.AddPlacement(new CoordinateLocation
        {
            Name = "Middle",
            SceneName = SceneNames.Tut_02,
            ...
            FlingType = ItemChanger.Enums.FlingType.Everywhere,
            Managed = false,
        }.Wrap().Add(Finder.GetItem(ItemNames.Left_Swift_Step)!));
    }
}
